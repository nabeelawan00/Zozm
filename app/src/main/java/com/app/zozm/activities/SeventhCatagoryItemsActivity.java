...
public class SeventhCatagoryItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_catagory_items);
            ...
            case R.id.tv_pandra:
                ...
                if (panda) {
                    tvPandra.getBackground().setColorFilter(getResources().getColor(R.color.colorPrimary),
                            PorterDuff.Mode.SRC_ATOP);
                    panda = false;
                    thirdArray.add(tvPandra.getText().toString());
                } else {

                    tvPandra.getBackground().setColorFilter(getResources().getColor(R.color.colorGray),
                            PorterDuff.Mode.SRC_ATOP);
                    panda = true;
                    thirdArray.remove(tvPandra.getText().toString());
